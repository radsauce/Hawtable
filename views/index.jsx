        ...
        <div className="container">
          <div className="jumbotron">
            ...
            <div className="text-center">
              <a href="tables.html"><button className="btn btn-lg btn-primary"><span className="fa fa-list-alt"></span> View Tables</button></a>
              <a href="reserve.html"><button className="btn btn-lg btn-danger"><span className="fa fa-credit-card"></span> Make Reservation</button></a>
            </div>
          </div>
